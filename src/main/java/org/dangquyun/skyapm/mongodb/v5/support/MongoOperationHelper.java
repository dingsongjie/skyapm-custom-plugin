...
package org.dangquyun.skyapm.mongodb.v5.support;
...
public class MongoOperationHelper {
    ...
    private static final ILog LOGGER = LogManager.getLogger(MongoOperationHelper.class);
    ...
    public static String getTraceParam(Object obj) {
        LOGGER.debug("Get operation param for class: {}", obj.getClass().getName());
