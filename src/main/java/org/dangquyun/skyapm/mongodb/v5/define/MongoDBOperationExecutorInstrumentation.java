...
public class MongoDBOperationExecutorInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String ENHANCE_CLASS = "com.mongodb.client.internal.MongoClusterImpl$OperationExecutorImpl";

    private static final String INTERCEPTOR_CLASS = "org.dangquyun.skyapm.mongodb.v5.interceptor.MongoDBOperationExecutorInterceptor";
